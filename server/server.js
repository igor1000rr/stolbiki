...
updatePost('v40-platform', 'v4.0: Competitive Platform', 'v4.0: Competitive Platform',
  'Snatch Highrise v4.0 — полноценная игровая платформа:\n\n**AI Game Review** — анализ каждого хода: отличный / хороший / ошибка / грубая ошибка. Accuracy % и replay с цветовой подсветкой.\n**Puzzle Rush** — 3 минуты, максимум головоломок. +10/-15 сек. Leaderboard.\n**Live Arena** — Swiss турниры: 4 раунда, auto-pairing, XP для топ-3.\n**5 уроков** — от основ до стратегии, интерактивная доска.\n**9 тем** — Dark, Ocean, Sunset, Forest, Royal, Neon, Wood, Arctic, Light.\n**8 скинов фишек** — Classic, Flat, Round, Glass, Metal, Candy, Pixel, Glow.\n**Анимации** — screen shake, 3D perspective, golden pulse.',
  'Snatch Highrise v4.0 — full competitive platform:\n\n**AI Game Review** — analyze every move: excellent / good / mistake / blunder. Accuracy % and color-coded replay.\n**Puzzle Rush** — 3 min, max puzzles. +10/-15 sec. Leaderboard.\n**Live Arena** — Swiss tournaments: 4 rounds, auto-pairing, XP for top 3.\n**5 lessons** — basics to strategy, interactive board.\n**9 themes** — Dark, Ocean, Sunset, Forest, Royal, Neon, Wood, Arctic, Light.\n**8 chip skins** — Classic, Flat, Round, Glass, Metal, Candy, Pixel, Glow.\n**Animations** — screen shake, 3D perspective, golden pulse.',
  'release', '2026-04-01 00:00:00')
updatePost('roadmap-2026', 'Планы на 2026', 'Roadmap 2026',
  '✅ Android-приложение\n✅ GPU-нейросеть 840K\n✅ AI Game Review\n✅ Puzzle Rush\n✅ Live Arena\n✅ 5 уроков\n✅ 9 тем + 8 скинов фишек\n✅ Login streak + missions + XP\n✅ 26 ачивок\n✅ i18n RU/EN\n\nДалее:\n→ Google Play\n→ Push-уведомления\n→ AI v4 (RTX 5090)\n→ iOS\n→ Seasonal cosmetics',
  '✅ Android app\n✅ GPU neural net 840K\n✅ AI Game Review\n✅ Puzzle Rush\n✅ Live Arena\n✅ 5 lessons\n✅ 9 themes + 8 chip skins\n✅ Login streak + missions + XP\n✅ 26 achievements\n✅ i18n RU/EN\n\nNext:\n→ Google Play\n→ Push notifications\n→ AI v4 (RTX 5090)\n→ iOS\n→ Seasonal cosmetics',

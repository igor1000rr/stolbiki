...
def build_pdf(rs, mev, mm, sp, vr, st, n=20000):
    ...
    tbl = [['Метрика', 'Значение', 'Оценка'],
        ...
        ['GPU Self-play (3 прогона, 1146 итер)', 'Loss min 0.098, WR best 97%', '840K, NVIDIA GPU'],
    ...
    s.append(Paragraph(
        ...
        "GPU: NVIDIA GPU. Время: 5с→36с/итер.", body))
    ...
    for i, c in enumerate([
        ...
        f"<b>GPU обучение (3 прогона, 1,146 итераций, NVIDIA GPU):</b> ResNet 840K параметров. "
    ...
    s.append(Paragraph(
        ...
        "(10) GPU Self-play прогон 3 (NVIDIA GPU): 500 итераций, LR=0.002, T_max=300, WR best 97% (~15,000 партий); "

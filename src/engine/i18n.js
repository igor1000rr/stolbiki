...
export const translations = {
  ru: {
    ...
    'game.replay': 'Повтор',
    'game.swapQuestion': 'Игрок 1 поставил первую фишку. Хотите поменять цвета?',
    ...
    'puzzle.closeStands': 'Закрывайте стойки за ограниченное число ходов',
    ...
    'openings.closeFreq': 'Частота закрытия (%)',
    'openings.p1Ownership': 'Владение P1 Синих (%)',
    'openings.avgCloseTurn': 'Средний ход закрытия',
    'openings.insights': 'Выводы',
    'openings.insight1': 'Стойка 5 — самый популярный первый ход (18.2%) и закрывается чаще всех',
    'openings.insight2': 'Золотая стойка (★) закрывается поздно (ход 14.2) — высокая стратегическая ценность',
    'openings.insight3': 'Крайние стойки (8,9) закрываются поздно и сложнее контролировать',
  ...
  en: {
    ...
    'game.share': 'Share',
    'game.replay': 'Replay',
    'game.swapQuestion': 'Player 1 placed first chip. Swap colors?',
    ...
    'puzzle.backBtn': 'Back',
    'puzzle.closeStands': 'Close stands in limited moves',
    ...
    'openings.closeFreq': 'Close frequency (%)',
    'openings.p1Ownership': 'P1 (Blue) ownership (%)',
    'openings.avgCloseTurn': 'Average close turn',
    'openings.insights': 'Key insights',
    'openings.insight1': 'Stand 5 is the most popular first move (18.2%) and closes most often',
    'openings.insight2': 'Golden stand (★) closes late (avg turn 14.2) — high strategic value',
    'openings.insight3': 'Edge stands (8,9) close late and are harder to control',

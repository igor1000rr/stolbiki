export default [
  ...
  },
  {
    ...
    changes_ru: [
      ...
      { type: 'new', text: '📸 Кнопка «Снимок» под 3D-городом: PNG + Web Share API с подписью «Мой Город побед — N побед!»' },
    ...
    changes_en: [
      ...
      { type: 'new', text: '📸 “Snapshot” button under 3D city: PNG + Web Share API with caption “My Victory City — N wins!”' },

...
const VERSIONS = [
  {
    ...
    changes_ru: [
      { type: 'new', text: 'SEO: path routing — /game, /rules, /en/game. Каждая страница индексируется отдельно (было 2, стало 16)' },
    ...
    changes_en: [
      { type: 'new', text: 'SEO: path routing — /game, /rules, /en/game. Each page indexed separately (was 2, now 16)' },

...
const VERSIONS = [
  ...
  },
  {
    ...
    changes_ru: [
      ...
      { type: 'fix', text: 'i18n полный — Game, Online, Profile, 33 ачивки с descEn' },
    ...
    changes_en: [
      ...
      { type: 'fix', text: 'Full i18n — Game, Online, Profile, 33 achievements with descEn' },
  ...
  },
  {
    ...
    changes_ru: [
      { type: 'new', text: '33 ачивки (было 14) с цветовыми категориями: бронза, серебро, золото, алмаз' },
    ...
    changes_en: [
      { type: 'new', text: '33 achievements (was 14) with color tiers: bronze, silver, gold, diamond' },

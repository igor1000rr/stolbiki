...
const VERSIONS = [
  {
    ...
    changes_ru: [
      ...
      { type: 'new', text: 'Тесты: 41→157 (+78). validate, helpers, stress, engine, score validation' },
    ...
    changes_en: [
      ...
      { type: 'new', text: 'Tests: 41→157 (+78). validate, helpers, stress, engine, score validation' },

...
const VERSIONS = [
  {
    ...
    changes_ru: [
      ...
      { type: 'new', text: 'Анимация доски — стойки вырастают при старте партии с stagger задержкой' },
    ...
    changes_en: [
      ...
      { type: 'new', text: 'Board intro animation — stands grow in with stagger delay on game start' },

...
const VERSIONS = [
  {
    version: '4.3',
    date: '2026-04-02',
    title_ru: 'SEO path routing, replay sharing, конфетти, лендинг',
    title_en: 'SEO path routing, replay sharing, confetti, landing',
    changes_ru: [
      { type: 'new', text: 'SEO: path routing — /game, /rules, /en/game вместо /#hash. Каждая страница индексируется Google и Яндекс отдельно' },
      { type: 'new', text: '/en/ URL routing — переключение языка меняет URL. hreflang теги, sitemap с 16 страницами' },
      { type: 'new', text: 'Replay sharing — сохраняйте партии и делитесь ссылкой. Кнопка «🔗 Поделиться» в результатах' },
      { type: 'new', text: 'Конфетти при победе — canvas-анимация из 120 частиц' },
      { type: 'new', text: 'Лендинг: 6 тем с анимацией падающих блоков, 6 карточек фич с живыми анимациями, секция Download' },
      { type: 'new', text: 'Error Boundary — при краше JS: Снуппи + перезагрузка вместо белого экрана' },
      { type: 'new', text: 'Анимация доски — стойки вырастают при старте партии' },
      { type: 'fix', text: 'Звуки подключены — клик, постановка, перенос, достройка, победа, поражение, swap (были написаны но не вызывались)' },
      { type: 'fix', text: 'Input sanitization — server/validate.js, XSS защита' },
      { type: 'fix', text: 'Автобэкап БД каждые 6 часов (28 слотов)' },
    ],
    changes_en: [
      { type: 'new', text: 'SEO: path routing — /game, /rules, /en/game instead of /#hash. Each page indexed by Google separately' },
      { type: 'new', text: '/en/ URL routing — language switch updates URL. hreflang tags, sitemap with 16 pages' },
      { type: 'new', text: 'Replay sharing — save games and share links. "🔗 Share" button in results' },
      { type: 'new', text: 'Confetti on victory — canvas animation with 120 particles' },
      { type: 'new', text: 'Landing: 6 themes with falling block animation, 6 feature cards with live animations, Download section' },
      { type: 'new', text: 'Error Boundary — JS crash shows Snoopy + reload instead of white screen' },
      { type: 'new', text: 'Board intro animation — stands grow in on game start' },
      ...
      { type: 'fix', text: 'Auto DB backup every 6 hours (28 slots)' },
    ],
  },
  {
    version: '4.2',

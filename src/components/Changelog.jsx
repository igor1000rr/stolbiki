...
const VERSIONS = [
  {
    version: '4.0',
    date: '2026-04-01',
    title_ru: 'AI анализ, Puzzle Rush, Arena, уроки, 9 тем, 8 скинов фишек',
    title_en: 'AI review, Puzzle Rush, Arena, lessons, 9 themes, 8 chip skins',
    changes_ru: [
      ...
      { type: 'new', text: '5 новых скинов фишек: Glass, Metal, Candy, Pixel, Glow (всего 8)' },
      { type: 'new', text: 'Animated board — screen shake при закрытии, 3D perspective, golden pulse' },
      { type: 'fix', text: 'Палитра под лого — accent coral→teal, все hardcoded цвета → CSS vars' },
      { type: 'fix', text: 'Все 26 компонентов полностью theme-aware (607 CSS var() в JSX)' },
    ],
    changes_en: [
      ...
      { type: 'new', text: '5 new chip skins: Glass, Metal, Candy, Pixel, Glow (8 total)' },
      { type: 'new', text: 'Animated board — screen shake on close, 3D perspective, golden pulse' },
      { type: 'fix', text: 'Color palette aligned with logo — accent coral→teal, all hardcoded → CSS vars' },

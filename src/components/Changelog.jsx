...
const VERSIONS = [
  {
    ...
    changes_ru: [
      ...
      { type: 'new', text: '«Что нового» — popup с Снуппи при первом визите после обновления' },
      ...
      { type: 'new', text: '"What\'s New" — popup with Snoopy mascot on first visit after update' },
      ...
      { type: 'new', text: 'Загрузка: Снуппи вместо текста «Загрузка...» — float-анимация маскота' },
      // SEO и документация
    ...
    changes_en: [
      ...
      { type: 'new', text: 'Loading: Snoopy mascot instead of "Loading..." text — float animation' },
      { type: 'new', text: 'SEO: BreadcrumbList + FAQPage JSON-LD, preconnect, noscript, hreflang, Telegram meta' },

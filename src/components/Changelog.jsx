...
const VERSIONS = [
  ...
  },
  {
    ...
    changes_ru: [
      ...
      { type: 'new', text: 'Keyboard shortcuts: ? — overlay with 7 shortcuts, styled kbd badges' },
      { type: 'new', text: '"What\'s New" — popup with Snappy mascot on first visit after update' },
      { type: 'new', text: '6 new Snappy cards: think, wave, celebrate, sad, point, shock — 3 sizes (sm/lg/full)' },

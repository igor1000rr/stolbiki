 ...
 *
 * 28.04.2026 — по ТЗ Александра ИЗНАЧАЛЬНО убрали видимую ⚙ из строки
 * (коммит 7c6e14a). После повторного обсуждения с Александром решено
 * вернуть: «Когда в приложении стойки станут по размеру, всё что снизу
 * под этой инфой сместится вниз и несимметричность не будет видна».
 * После уменьшения стоек на mobile (d0715e1) шестерёнка не выглядит
 * перегружающе и помогает новичкам понять что строка кликабельна.
 */
  ...
  return (
    ...
    >
      ...
      {/* Подсказка ⚙ — намёк что строка кликабельна. На native откроется
          ...
          28.04.2026 — после уменьшения стоек на mobile (d0715e1) Александр
          одобрил возврат иконки: «Когда стойки станут по размеру, всё что
          снизу сместится вниз и несимметричность не будет видна». */}
      {onSettingsOpen && (

 ...
 *
 * Почему .jsx + happy-dom: сам _utils.jsx содержит JSX (функция sparkline возвращает
 * <svg>), и импорт .jsx из .js тест-файла в Node env ломает vite transform pipeline
 * (зависит от конфига). Проще держать тест как .jsx с happy-dom env — тогда pipeline
 * однозначный.
 */
